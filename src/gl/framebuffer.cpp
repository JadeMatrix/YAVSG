...
namespace yavsg { namespace gl // Base framebuffer implementation //////////////
{
    ...
    base_framebuffer::alpha_blend_mode base_framebuffer::alpha_blending(
    ...
    base_framebuffer::alpha_blend_mode base_framebuffer::alpha_blending() const
    {
        return _alpha_blending;
    }
    
    void base_framebuffer::dump_BMP( const std::string& descriptive_name )
    {
